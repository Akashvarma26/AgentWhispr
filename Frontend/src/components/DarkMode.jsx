...
function useDarkMode() {
  ...
  // Check if dark mode is already active (set by blocking script in HTML)
...
export default function DarkModeToggle() {
  ...
  return (
    ...
    >
      {isDark ? <svg xmlns="http://www.w3.org/2000/svg" height="24px" width="24px" viewBox="0 -960 960 960">
