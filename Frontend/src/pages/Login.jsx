...
export function Login() {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      setStatusMsg("❌ Google Auth Error: " + err.message);
    }
  };

  return (
    <>
      <title>Agent Whispr - Login</title>
      <header>
        <nav>
          <ul>
            <li>
      ...
      <main>
        <section className="contact-info-section">
          <div className="login-card">
            <h2 className="card-title">Login to Agent Whispr</h2>
            ...
            <form onSubmit={handleLogin}>
              ...
              {statusMsg && (
                <div style={{ marginTop: "15px", color: "red" }}>{statusMsg}</div>
              )}
            </form>
